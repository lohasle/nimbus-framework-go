<template>
  <doc-alert title="用户体系" url="https://doc.nimbus.local/user-center/" />
  <doc-alert title="三方登陆" url="https://doc.nimbus.local/social-user/" />
  <doc-alert title="Excel 导入导出" url="https://doc.nimbus.local/excel-import-and-export/" />
