<template>
  <doc-alert title="支付宝支付接入" url="https://doc.nimbus.local/pay/alipay-pay-demo/" />
  <doc-alert title="支付宝、微信退款接入" url="https://doc.nimbus.local/pay/refund-demo/" />
  <doc-alert title="微信公众号支付接入" url="https://doc.nimbus.local/pay/wx-pub-pay-demo/" />
  <doc-alert title="微信小程序支付接入" url="https://doc.nimbus.local/pay/wx-lite-pay-demo/" />
